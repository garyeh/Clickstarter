...
pantry = Project.create(title: "MyPantry", main_image_url: "http://res.cloudinary.com/ds1qfel8a/image/upload/c_scale,w_1080/v1495161001/Stock/Pantry_adfpkv.jpg",
url: "https://mypantry.herokuapp.com/#/", description: "For cooking enthusiasts - a website that keeps track of your pantry so you don't have to! Inspired by RemembertheMilk, myPantry allows users to add items to their pantry, update and delete current pantry items, make grocery lists and update their pantry with purchased grocery items.", end_date: "2019-02-08", funding_goal: 10000, creator_id: miriam.id, category: "Food", details: miriam_text)
open_gym = Project.create(title: "OpenGym", main_image_url: "http://res.cloudinary.com/ds1qfel8a/image/upload/v1495161000/Stock/OpenGym_miycjc.jpg",
url: "https://opengymvolleyball.herokuapp.com/#/", description: "A Yelp...for volleyball gyms! Designed to help users find volleyball open gyms within the city of search. The application is built utilizing Ruby on Rails and PostgresSQL database in the back-end, and React/Redux in the front-end.", end_date: "2019-01-19", funding_goal: 100000, creator_id: brandon.id, category: "Sports", details: brandon_text)
...
url: "https://unbottld.herokuapp.com/#/", description: "Find your favorite bottle! UNBOTTLD is a single page web app that was inspired by UNTAPPD, where users can keep track of what beers they've tried by rating it and also see what other people are drinking.", end_date: "2020-03-30", funding_goal: 50000, creator_id: mark.id, category: "Food", details: mark_text)
...
url: "https://vibemusic.herokuapp.com/", description: "Discover, stream, and share a constantly expanding mix of music from emerging and major artists around the world. Inspired by Soundcloud.", end_date: "2018-11-21", funding_goal: 14000, creator_id: winber.id, category: "Music", details: winber_text)
...
url: "http://artsie.herokuapp.com/#/", description: "Original artworks from artists for artists. Artsie is a web app that showcases and sells artistic masterpieces. It was built using Ruby on Rails, React/Redux, and PostgreSQL.", end_date: "2020-03-03", funding_goal: 7000, creator_id: vu.id, category: "Art", details: vu_text)
...
url: "http://eventsintown.herokuapp.com/#/", description: "Find your next experience. EventsInTown is a web application inspired by Eventbrite allowing users to discover events that match their interests, bookmark events for later viewing, purchase tickets, or create and host their own events with online ticketing.", end_date: "2021-07-01", funding_goal: 1500, creator_id: jill.id, category: "Entertainment", details: jill_text)
...
url: "https://chillcloud.herokuapp.com/#/", description: "Listen & chill. ChillCloud is a web application modeled after SoundCloud and produced within a two-week timeline. It mainly utilizes Ruby on Rails, React/Redux, PostgreSQL database, and Amazon Web Services S3 storage.", end_date: "2022-02-12", funding_goal: 2000, creator_id: ranelle.id, category: "Music", details: ranelle_text)
upshift = Project.create(title: "UpShift", main_image_url: "http://res.cloudinary.com/ds1qfel8a/image/upload/c_scale,w_1080/v1498174214/Stock/upshift_kxrt75.png",
url: "https://upshiftapp.herokuapp.com/#/", description: "A new way to buy used cars. On the front-end, it uses React.js and Redux. On the back-end, it utilizes Ruby on Rails, a PostgreSQL database and jBuilder to build the data feeds.", end_date: "2018-10-10", funding_goal: 8000, creator_id: jon.id, category: "Autos", details: jon_text)
...
sam_pledge2 = Pledge.create(reward_id: sam_reward5.id, backer_id: winber.id)
